 ...
 *
 * Lit le .env via Env::load. Les valeurs BIO_* pilotent à la fois le backend
 * et le front (via l'endpoint GET /api/config/biometrie).
 */
...
return [
    ...
    'simulation'      => Env::bool('BIO_SIMULATION', true),
];
